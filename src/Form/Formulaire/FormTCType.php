...
class FormTCType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('formations', ChoiceType::class, [
            'choices' => [
                'TC' => [
                    'DUT TC' => 'DUT TC',
                    'LP Commercialisation Agrodistribution et Agroalimentaire' => 'LP Commercialisation Agrodistribution et Agroalimentaire',
                    'LP Evènementiel' => 'LP Evènementiel',
                    'LP Logistique' => 'LP Logistique',
                ],],
                'multiple' => true,
                'expanded' => true,
        ])
            ...
            ->add('provenances', ChoiceType::class, [
                ...
                'choice_attr' => [
                    'Autre' => ['id' => 'checkbox-provenances-autre'],
                  ],
            ])
