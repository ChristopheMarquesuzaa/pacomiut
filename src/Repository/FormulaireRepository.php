...
class FormulaireRepository extends ServiceEntityRepository
{
    ...
    /**
     * @return Formulaire Retourne le formulaire actif courant de la formation et du bon type
     */
    public function findActifByDepartementAndType(Departement $departement, int $type)
    {
